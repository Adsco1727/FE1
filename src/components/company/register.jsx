  ...
  return (
    <Row className="container pt-50 pb-30" justify={"center"}>
      <Col key={"companyRegisterArea"} xs={24} sm={24} md={20} lg={16} xl={16}>
        <Typography.Title key={"level1Title"} className={"c-green text-center"}>
          List Your Company
        </Typography.Title>
        <Typography.Title
          key={"level3Title"}
        ...
        >
          Please complete the following information to create your Account and
          List on the Direct Private Offers Funding Portal.
        </Typography.Title>
        <Typography.Title key={"level5title"} level={5}>
        ...
        >
          ...
          <Form.Item key={"Message"} name={"message"} label={"Message"}>
            <Input.TextArea
              key={"messageInput"}
              rows={5}
              showCount
          ...
          >
            <Checkbox key={"userAgreementCheckBox"} onChange={confirmChecked}>

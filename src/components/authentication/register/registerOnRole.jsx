...
export default function MCRegisterOnRole(props) {
  ...
  const confirmChecked = () => {
    if (
      form.getFieldValue("storeAgreement") &&
      form.getFieldValue("purchaseAgreement")
    ) {
      setDisabled(false);
    } else {
      setDisabled(true);
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  ...
                  return Promise.reject(
                    new Error(
                      "The two email addresses you have entered do not match"
                    )
                  );
                },
              }),
